...
If you believe you've found a vulnerability, please use [GitHub private vulnerability reporting](https://github.com/Prometheus-X-association/consent-manager/security/advisories/new) for coordinated disclosure.
